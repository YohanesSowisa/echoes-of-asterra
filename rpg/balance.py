...
DIFFICULTY_PROFILES: Dict[str, DifficultyProfile] = {
    "explorer": DifficultyProfile("Explorer", hp_mult=0.75, dmg_mult=0.70, xp_mult=1.20, potion_heal_mult=1.30, ai_aggro_mult=0.70, hp_regen_mult=2.00),
    "normal": DifficultyProfile("Normal", hp_mult=1.00, dmg_mult=1.00, xp_mult=1.00, potion_heal_mult=1.00, ai_aggro_mult=1.00, hp_regen_mult=1.00),
    "veteran": DifficultyProfile("Veteran", hp_mult=1.30, dmg_mult=1.35, xp_mult=1.15, potion_heal_mult=0.85, ai_aggro_mult=1.30, hp_regen_mult=0.50),
    "nightmare": DifficultyProfile("Nightmare", hp_mult=1.70, dmg_mult=1.75, xp_mult=1.30, potion_heal_mult=0.65, ai_aggro_mult=1.60, hp_regen_mult=0.20),
}
